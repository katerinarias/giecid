...
autores: ["Segundo Quintriqueo", "Katerin Arias", "Gerardo Muñoz", "Hector Torres", "Soledad Morales", "Fernando Peña"]
venue: "RBCS"
categories: ["2021", "RBCS"]
preprint: "pdfs/productividad/PRODUCTIVIDAD_2021_KARIAS/ART_N°3_QUINTRIQUEO Y ARIAS-ORTEGA_RBCS_2021_SCOPUS.pdf"
---
**Autores**: [{{< meta autores.1 >}}](../members/current/segundoquintriqueo.qmd), [{{< meta autores.2 >}}](../members/current/katerinarias.qmd), {{< meta autores.3 >}}, {{< meta autores.4 >}}, {{< meta autores.5 >}}, {{< meta autores.6 >}}  
**Lugar de publicación**: {{< meta venue >}}   
**Categorias**: [{{< meta categories.1 >}}](../publications.qmd#category=2021), [{{< meta categories.2 >}}](../publications.qmd#category=RBCS)  
