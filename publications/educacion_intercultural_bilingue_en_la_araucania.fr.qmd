...
autores: ["Katerin Arias", "Daniel Quilaqueo", "Segundo Quintriqueo"]
venue: "FONDECYT"
categories: ["2019", "FONDECYT", "Educación Intercultural", "Desafíos epistémicos", "Epistemología contextual"]
preprint: "pdfs/productividad/PRODUCTIVIDAD_2019_KARIAS/ART_1_SCOPUS.pdf"
---
**Autores**: [{{< meta autores.1 >}}](../members/current/katerinarias.qmd), {{< meta autores.2 >}}, [{{< meta autores.3 >}}](../members/current/segundoquintriqueo.qmd)  
**Lugar de publicación**: {{< meta venue >}}   
**Categorias**: [{{< meta categories.1 >}}](../publications.qmd#category=2019), [{{< meta categories.2 >}}](../publications.qmd#category=FONDECYT), [{{< meta categories.3 >}}](../publications.qmd#category=Educación+Intercultural), [{{< meta categories.4 >}}](../publications.qmd#category=Desafíos+epistémicos), [{{< meta categories.5 >}}](../publications.qmd#category=Epistemología+contextual)  
