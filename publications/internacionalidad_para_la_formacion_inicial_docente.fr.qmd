...
capitulo: "Todos"
categories: ["2016", "Libro", "Formación Docente", "Interculturalidad"]
preprint: "pdfs/productividad/PRODUCTIVIDAD_2016_KARIAS/Libro-Interculturalidad-formacion-docente-UCT.pdf"
---
**Autores**: [{{< meta autores.1 >}}](../members/current/segundoquintriqueo.qmd), {{< meta autores.2 >}}, {{< meta autores.3 >}},[{{< meta autores.4 >}}](../members/current/katerinarias.qmd)
**Libro**: {{< meta libro >}}   
**Capítulo**: {{< meta capitulo >}}   
**Categorias**: [{{< meta categories.1 >}}](../publications.qmd#category=2016), [{{< meta categories.2 >}}](../publications.qmd#category=Libro), [{{< meta categories.3 >}}](../publications.qmd#category=Formación_Docente), [{{< meta categories.4 >}}](../publications.qmd#category=Interculturalidad)  
